...
网页全自动流水线页现已同步展示扩展候选宇宙、Benchmark 指标、五维靶点验证、最终冲突决策、外部队列验证、伪 bulk omics QC、PoseBusters 状态、结构质量门控和 reproducibility manifest；表单也可直接设置候选扩展、阳性/阴性 benchmark、外部验证表和 REVIEW 对接开关。
